...
int main(int argc, char **argv) {
	...
	if (argc < 6)
	{
		printf("Give parameters file input: pbc-0.5.14/param/a1.param, Hash, Path to artifacts, key_id (1 for private_key1), Signature File Name\n");
		return 0;
	}
	...
	sprintf(signature_path, "%s.signature", argv[5]);
